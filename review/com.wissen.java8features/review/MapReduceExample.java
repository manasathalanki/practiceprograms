...
public class MapReduceExample {
	...
	public static void main(String[] args) {
		...
		List<String> colors = Arrays.asList("Red", "Green", "Blue", "Pink", "Brown","AppleGreen");
		// Count strings starting with a specific letter
		long ctr = colors.stream().filter(s -> s.startsWith(String.valueOf('m'))).count();
		...
		System.out.println(numbersList.stream().reduce(Integer::max).get());
		System.out.println(numbersList.stream().reduce(Integer::min).get());
